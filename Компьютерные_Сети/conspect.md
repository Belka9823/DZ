...
Network).
Сервер (от англ. server – служащий, служитель) – компьютер или программа, предоставляющая услуги другим компьютерам или программам,
...
6000 узлов ARPANET и практически вывел из строя сеть. Как один из результатов была организована CERT (computer emergency response team).
...
![Телекомуникационные сети](/Внедрение_и_поддержка_комп.систем/img_CS/Screenshot_3.png)
![Телекомуникационные сети](/Внедрение_и_поддержка_комп.систем/img_CS/Screenshot_4.png)
![Телекомуникационные сети](/Внедрение_и_поддержка_комп.систем/img_CS/Screenshot_5.png)
![Телекомуникационные сети](/Внедрение_и_поддержка_комп.систем/img_CS/Screenshot_6.png)